    ...
    <>
      <SideBar>
        ...
        <div>
          ...
          <Button type="primary" style={{ marginLeft: "20px" }} onClick={handleDownload} icon={<DownloadOutlined />} size={size}>
            Download
          </Button>


          <Button type="primary" style={{ marginLeft: "20px" }} onClick={handleSingleEliminate} icon={<PoweroffOutlined />} size={size}>
            Single Eliminate
          </Button>
