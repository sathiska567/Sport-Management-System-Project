...
const ForgetPassword = () => {
  ...
  const changePassword = async () => {
    ...
    setPasswordError(null); setConfirmPasswordError(null); setError('')
    if (!validateFields()) {
      return;
    }
      ...
      <div className="CreatePasswordDetails">
        ...
        <div>
          <Form name="nest-messages">
            ...
            <Input
              type="password"
              className={`CreatePasswordInput ${passwordError==null?'':passwordError ? 'error' : 'success'}`}
              id="password"
              name="password"
            ...
            <Input
              type="password"
              className={`CreatePasswordInput ${confirmPasswordError==null?'':confirmPasswordError ? 'error' : 'success'}`}
              id="password"
              name="password"
