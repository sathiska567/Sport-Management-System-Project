...
axios.defaults.baseURL = "http://localhost:8080/api/v1/matchDetails"
...
function PlayerMatchDetails() {
    ...
    const getFetchData = async (name, date) => {
        ...
        const data = await axios.get(`/get-match-details?q=${name}&date=${date}`)
        console.log(data)
