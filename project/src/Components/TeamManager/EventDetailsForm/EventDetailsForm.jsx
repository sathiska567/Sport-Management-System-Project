  ...
  const handleCreate = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/api/v1/EventDetailsForm/createEventDetailsForm",
        {  
    ...
    <div>
      <TeamManagerSideBar>
        ...
        <Form
          ...
          layout="verticle"
        >
          <div style={{}} className="EventForm">
            <div
              style={{
                backgroundColor: "#15295E",
              }}
              className="EventFormHeader"
            >
              <h3
                style={{
                  color: "white",
            ...
            <div
              ...
              className="EventFormApplication"
            >
